...
public class CG {
    ...
    //static ArrayList<Integer> timesIndex = new ArrayList<Integer>();
    ...
    public static void createLines() throws FileNotFoundException, UnsupportedEncodingException {
        ...
        firstInstruction++;
        //  tokenCount = Compiler.tokens.indexOf("BEGIN") + 1;
        ...
        while (!Compiler.tokens.get(0).equals("END.")) {
            if (Compiler.tokens.get(0).equalsIgnoreCase("READ")) {//braces stopping point
              ...
              Compiler.tokens.remove(0);
                ...
                i = 0;
                while (!Compiler.tokens.get(i).equalsIgnoreCase(";")) {
                    // assignstmt += Compiler.tokens.get(i) + " ";
                ...
                if (Variables.size() == 4) {
                    ...
                    if (plusflag == 0 && timesflag == 0) {
                        ...
                        /*    if(Variables.get(0).equals(Variables.get(2)))
                    {lines.add(sk + "LDA" + sp + Variables.get(2));
                    lines.add(sk + "ADD" + sp + Variables.get(4));*/
                        if (duplicates != 0) {
...
//ArrayList<String> Variablescpy= new ArrayList<String>(Variables);
